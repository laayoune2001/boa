...
const showBtnb = document.querySelector('#show-btn-1');
const showTextb = document.querySelector('.hide-boa-text');
let isExpended = false;

showBtnb.addEventListener('click', ()=> {
	showTextb.classList.toggle('active');
	isExpended = showTextb.classList.contains('active');

	if(isExpended) {
		showBtnb.innerHTML = 'Show less';
	} else {
		showBtnb.innerHTML = 'Show more';
